...
namespace MedicappApi.Controllers
{
  ...
  public class PedidosController : ControllerBase
  {
    ...
    public PedidosController(IDapper dapper)
    {
      _dapper = dapper;
    }
    ...
    public ActionResult Get()
    {
      ...
      string query = @$"SELECT OP.ID, OP.FECHAINICIO, OP.COMENTARIOS, EL.DESCRIPCION AS ELEMENTODESCRIPCION, EL.IMAGEN AS IMAGEN,
                        ...
                        AND OP.TIPOOPERACIONID = (SELECT ID FROM TIPOOPERACION WHERE DESCRIPCION = 'pedido') {whereUsuario}";
    ...
    public ActionResult Post([FromBody] OperacionCrud operacion)
    {
      try
      {
        string query = @$"INSERT INTO 
                        ...
                        VALUES ({operacion.UsuarioId}, {operacion.ElementoId}, 1, 1, getdate(), '{operacion.Comentarios}')";
